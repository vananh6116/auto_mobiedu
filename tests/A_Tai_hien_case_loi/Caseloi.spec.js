...
function case9() {
    test('Case lỗi 9: Thêm và sửa KH API ', async ({ page }) => {
        ...
        await page.goto(dataSiteTest[1].linkSite + "/course-api");
        await page
            .locator('tbody > tr')
...
function case15() {
    test('Case lỗi 15: click btn chủ đề', async ({ page }) => {
        ...
        await expect(page).toHaveURL(dataSiteTest[1].linkSite + "/tin-tuc/tin-tuc");
        ...
        await expect(page).toHaveURL(dataSiteTest[1].linkSite + "/tin-tuc/tuyen-sinh");
