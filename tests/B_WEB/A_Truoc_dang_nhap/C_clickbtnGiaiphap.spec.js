...
function case1 () {
    test('Case 1: click logo trường mầm non, tiểu học - mobiEdu SLL', async ({ page }) => {
        ...
        // Expect 
        await expect(page).toHaveURL('https://mskill8.mobiedu.vn/giai-phap');
        ...
        // Expect 
        await expect(page).toHaveURL('https://mskill8.mobiedu.vn/giai-phap/truong-mam-non-tieu-hoc');
        // Click logo mobiEdu SLL
        await page.getByLabel('1 / 1').getByRole('link').click();
        // Expect 
        await expect(page).toHaveURL('https://mskill8.mobiedu.vn/giai-phap/truong-mam-non-tieu-hoc/mobiedu-sll');
...
function case2 () {
    test('Case 2: click gắn link mobiEdu SLL', async ({ page }) => {
        ...
        await page.goto('https://mskill8.mobiedu.vn/giai-phap');
        await page.getByLabel('1 / 4').getByRole('link').click();
...
function case3 () {
    test('Case 3: click link btn DN-DH-PT-MN&TH', async ({ page }) => {
        ...
        // Expect 
        await expect(page).toHaveURL('https://mskill8.mobiedu.vn/giai-phap/doanh-nghiep');
        // Click mSchool Doanh nghiệp 
        await page.keyboard.press('PageDown');
        await page.keyboard.press('PageDown');
        await page.locator('a').filter({ hasText: 'mSchool Doanh nghiệp' }).click();
        // Expect 
        await expect(page).toHaveURL('https://mskill8.mobiedu.vn/giai-phap/doanh-nghiep/mschool-doanh-nghiep');
        // Click Trường Đại học
        await page.keyboard.press('PageDown');
        await page.keyboard.press('PageDown');
        await page.getByRole('link', { name: 'Trường Đại học' }).click();
        // Expect
        await expect(page).toHaveURL('https://mskill8.mobiedu.vn/giai-phap/truong-dai-hoc');
        // Click Trường Phổ thông - mobiEdu mSchool - mobiEdu TKB - Onluyen.vn
        await page.goto('https://mskill8.mobiedu.vn/giai-phap/truong-mam-non-tieu-hoc/mobiedu-sll');
        await page.keyboard.press('PageDown');
        await page.keyboard.press('PageDown');
        await page.getByRole('link', { name: 'Trường Phổ thông' }).click();
        // Expect
        await expect(page).toHaveURL('https://mskill8.mobiedu.vn/giai-phap/truong-pho-thong');
        // Click mobiEdu mSchool
        await page.keyboard.press('PageDown');
        await page.keyboard.press('PageDown');
        await page.locator('a').filter({ hasText: 'mobiEdu mSchool' }).click();
        // Expect
        await expect(page).toHaveURL('https://mskill8.mobiedu.vn/giai-phap/truong-pho-thong/mobiedu-mschool');
        // Click mobiEdu TKB
        await page.keyboard.press('PageDown');
        await page.keyboard.press('PageDown');
        await page.getByRole('link', { name: 'mobiEdu TKB' }).click();
        // Expect
        await expect(page).toHaveURL('https://mskill8.mobiedu.vn/giai-phap/truong-pho-thong/mobiedu-tkb');
        // Click Onluyen.vn
        await page.keyboard.press('PageDown');
        await page.keyboard.press('PageDown');
        await page.getByRole('link', { name: 'Onluyen.vn' }).click();
        // Expect
        await expect(page).toHaveURL('https://mskill8.mobiedu.vn/giai-phap/truong-pho-thong/onluyen-vn');
...
function case5 () {
    test('Case 5: click gắn link mobiEdu mSchool ', async ({ page }) => {
        ...
        await page.goto('https://mskill8.mobiedu.vn/giai-phap/truong-pho-thong');
        await page.getByLabel('2 / 4').getByRole('link').click();
        await page.locator('div.swiper-slide.swiper-slide-active > div > div.image.mx-auto').click();
        await page.locator('section.solution-7.animate > div > div.desktop-show > div > div.image > a > img').click();
        // Expect 
...
function case6 () {
    test('Case 6: click gắn link mobiEdu TKB', async ({ page }) => {
        ...
        await page.locator('div.desktop-show > div > div.image.img-scale > a > img').click();
        // Expect 
        await expect(page).toHaveURL('https://mskill8.mobiedu.vn/giai-phap/truong-pho-thong/giai-phap-sap-xep-thoi-khoa-bieu');
...
function case10 () {
    test('Case 10: click gắn link mSchool Doanh nghiệp', async ({ page }) => {
        ...
        await page.goto('https://mskill8.mobiedu.vn/giai-phap/doanh-nghiep');
        await page.getByLabel('2 / 4').getByRole('link').click();
        await page.locator('section.solution-7.animate > div > div.desktop-show > div > div.image > a > img').click();
        // Expect 
        await page.goto('https://mschool.mobiedu.vn/?_gl=1*dwwo7t*_ga*MTY1MDk4MDY5NC4xNzAxMjUyNDI2*_ga_ZZM9L108RW*MTcwMTI1MjQyNS4xLjEuMTcwMTI1MjY3Ni4wLjAuMA..');
